...
function ReactTable({ columns: userColumns, data, statuses, getHeaderProps }: Props) {
      ...
      <Stack direction={matchDownSM ? 'column' : 'row'} spacing={1} justifyContent="space-between" alignItems="center" sx={{ p: 3, pb: 3 }}>
        ...
        <Stack direction={matchDownSM ? 'column' : 'row'} alignItems="right" justifyContent="right" spacing={matchDownSM ? 1 : 2}>
          ...
          <Stack direction={matchDownSM ? 'column' : 'row'} alignItems="center" spacing={1}>
            ...
            <Button variant="contained" startIcon={<PlusOutlined />} onClick={() => navigation('/sales/invoices/create')} size="small">
              Add Invoice
            </Button>
