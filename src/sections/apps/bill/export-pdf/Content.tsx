      ...
      <View style={[styles.row, styles.subRow]}>
        ...
        <View style={styles.card}>
          ...
          <Text style={[styles.caption, styles.pb5]}>
            {list?.vendor?.firstName && list?.vendor?.lastName
              ? `${list.vendor.firstName} ${list.vendor.lastName}`
              : list?.vendor?.firstName}
          </Text>
          {/* <Text style={[styles.caption, styles.pb5]}>{list?.customer?.city}</Text> */}
          <Text style={[styles.caption, styles.pb5]}>{list?.vendor.phoneNumber}</Text>
          <Text style={[styles.caption, styles.pb5]}>{list?.vendor.email}</Text>
        </View>
      </View>
      <View>
