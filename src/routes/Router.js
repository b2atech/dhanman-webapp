...
const ThemeRoutes = [
  {
    ...
    children: [
      ...
      { path: '/masters/vendors', name: 'Customer', exact: true, element: <Vendors/> },
      { path: '/masters/Tags', name: 'Customer', exact: true, element: <Tags/> },
      { path: '/masters/TagTypes', name: 'Customer', exact: true, element: <TagTypes/> },
