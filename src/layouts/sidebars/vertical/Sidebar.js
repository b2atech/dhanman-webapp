...
import user1 from '../../../assets/images/users/mavala.png';
import probg from '../../../assets/images/bg/mavalabk.png';
    ...
    <div className={`sidebarBox shadow bg-${activeBg} ${isFixed ? 'fixedSidebar' : ''}`}>
      <SimpleBar style={{ height: '100%' }}>
        <div className="profilebg" style={{ background: `url(${probg}) no-repeat` }}>
          ...
          <div className="bg-dark text-dark-white p-2 opacity-75 text-truncate">Rayaba Mavala</div>
        </div>
        {/********Sidebar Content*******/}
